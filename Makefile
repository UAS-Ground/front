...
DISTDIR = /home/tyler/NEW_UAV/front/.tmp/UAS_GS_Client1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/tyler/Qt/5.8/gcc_64/lib -Wl,-rpath-link,/home/tyler/Qt/5.8/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -lprotobuf -L/home/tyler/OpenCV/build/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_videoio -lopencv_objdetect -L/home/tyler/Qt/5.8/gcc_64/lib -lQt5QuickControls2 -lQt5Location -lQt5Quick -lQt5Multimedia -lQt5Gui -lQt5Qml -lQt5Network -lQt5Positioning -lQt5Core -lGL -lpthread -lpulse-mainloop-glib -lpulse -lglib-2.0 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = main.cpp \
		...
		searchrequest.pb.cc \
		roscontroller.cpp \
		navgoalcommand.pb.cc qrc_qml.cpp \
		qrc_mapviewer.cpp \
...
DIST          = android/AndroidManifest.xml \
		...
		UAS_GS_Client.pro cvcontroller.h \
		searchrequest.pb.h \
		roscontroller.h \
		navgoalcommand.pb.h main.cpp \
		cvcontroller.cpp \
		searchrequest.pb.cc \
		roscontroller.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents cvcontroller.h searchrequest.pb.h roscontroller.h navgoalcommand.pb.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp cvcontroller.cpp searchrequest.pb.cc roscontroller.cpp navgoalcommand.pb.cc $(DISTDIR)/
...
qrc_qml.cpp: qml.qrc \
		...
		CustomGauge.qml \
		GroundSystemFeatureButton.qml \
		GroundSystemModal.qml \
		SensorGaugeView.qml \
		CommandPage.qml \
		SensorGraphView.qml \
		SensorView.qml \
...
moc_roscontroller.cpp: ../../Qt/5.8/gcc_64/include/QtCore/QObject \
		...
		../../Qt/5.8/gcc_64/include/QtNetwork/QNetworkSession \
...
searchrequest.pb.o: searchrequest.pb.cc searchrequest.pb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o searchrequest.pb.o searchrequest.pb.cc
...
navgoalcommand.pb.o: navgoalcommand.pb.cc navgoalcommand.pb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o navgoalcommand.pb.o navgoalcommand.pb.cc
