...
public:
     ...
     */
    CameraTask(BetterVideoCapture* camera, QVideoFrame* videoFrame, unsigned char* cvImageBuf, int width, int height, int * brightness, float * contrast, bool * objectDetectionActive);
...
public:
     ...
     * @param height Height of the camera image
     */
    CameraThread(BetterVideoCapture* camera, QVideoFrame* videoFrame, unsigned char* cvImageBuf, int width, int height, int * brightness, float * contrast, bool * objectDetectionActive);
