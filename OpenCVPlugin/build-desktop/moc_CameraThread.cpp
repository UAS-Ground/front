...
void CameraTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CameraTask::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CameraTask::imageReady)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CameraThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CameraThread.data,
